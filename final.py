...
def process_text():
    ...
    if audio_type == "custom" and custom_prompt:
        ...
        prompts = {
            "meeting": """Give 5 points only, no paragraphs.dont include *or**or# in pdf""",
            "education": """Give 3 points only, no paragraphs. note: dont include * or**or# in pdf""",
...
def upload_file():
    ...
    prompts = {
        "meeting": "Explain in detail . dont include **text** for bullet",
        "education": "Provide 3 educational insights from the transcription.dont include *or**or# in pdf",
        "speech": "Convert the transcription into structured paragraphs with appropriate headings. dont add * or ** or # in pdf",
    }

    # Select prompt based on audio type or use custom prompt
    if audio_type == "custom" and custom_prompt:
        prompt = custom_prompt  # Use the user-entered custom prompt
